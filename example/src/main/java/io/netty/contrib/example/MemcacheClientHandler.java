 ...
 * under the License.
 */
package io.netty.contrib.example;

import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import io.netty.channel.ChannelHandler;
import io.netty.channel.ChannelHandlerContext;
import io.netty.contrib.handler.codec.memcache.binary.BinaryMemcacheOpcodes;
import io.netty.contrib.handler.codec.memcache.binary.BinaryMemcacheRequest;
import io.netty.contrib.handler.codec.memcache.binary.DefaultBinaryMemcacheRequest;
import io.netty.contrib.handler.codec.memcache.binary.DefaultFullBinaryMemcacheRequest;
import io.netty.contrib.handler.codec.memcache.binary.FullBinaryMemcacheResponse;
